...
class Restclient
{
    ...
    private static $paramsOnUrlMethod = array(
        'GET',
        'DELETE'
    );
     ...
     * @return RESTClient
     */
    public function call($url, $method, $postFields = null, $username = null, $password = null, $contentType = null, $header_append = array())
    {
        ...
        if ($header_append) {
            curl_setopt($this->ch, CURLOPT_HTTPHEADER, $header_append);
        }
     ...
     * @return RESTClient
     */
    public function _POST($url, $params = null, $username = null, $password = null, $contentType = null, $header_append = array())
    {
        $response = $this->call($url, 'POST', $params, $username, $password, $contentType, $header_append);
     ...
     * @return RESTClient
     */
    public function _GET($url, $params = null, $username = null, $password = null, $contentType = null, $header_append = array())
    {
        $response = $this->call($url, 'GET', $params, $username, $password, $contentType, $header_append);
        return $this->parseResponse($response);
    }
    ...
    {
        // FIXME:never used param:$ext; it is not normal;
        ...
        switch ($ext) {
            case 'json':
                ...
                $decode_result = json_decode($resp, true);
                if ($decode_result !== null) {
                    // if null, means data cant be decode; return the resp itself;
                    $resp = $decode_result;
                }
                break;
            case 'xml':
