...
<form action="admin/project/getList?page=0" method="get">
	<div class="search"  style='float:left;'>
		<div class="form-inline">
			...
			<input type="text" class="form-control search_input" name="name"
				id="title"
				value="<?php echo isset($data['name'])&&!is_null($data['name'])?$data['name']:'';?>"
